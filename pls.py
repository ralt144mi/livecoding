...
jj * d(". juj:[0:45]", p=4, euclid=(3,7,2), shape=0.35,
        orbit=7, room=0.85, sz=0.85, gain=0.9, scram ="0.5 0 (ulsin 2) 2",
        delay=0.9,delaytime="0.01+(ulsin 4)/2", delayfeedback=0.67
        )

Pj * d("lsdelectro:[0~52]", p=4, euclid=(3,7,2), shape=0.35,
        orbit=7, room=0.85, sz=0.85, gain=0.8, scram ="0.5 0 (ulsin 2) 2",
        delay=0.9,delaytime="0.01+(ulsin 4)/2", delayfeedback=0.67
        )

Pd * d('lsdelectro:[0:10]', amp=0.4, p=.5, leg=.05, pan='rand', 
       speed='(if (beat 0 2) 1 0.5)*2', hpf='2000+(ulsin 4)', orbit=5)
Pe * d('[.]!8 lsdlovely:[0:10]', p='.25', leg=.1, amp='0.3~0.5 * (ulsin 0.5)', 
       pan='(ultri 4)', speed='2!4 4!4')

PK * d("protokick",p=1,lpf="500", res=0.2, shape=0.5)

PK * d("(eu protokick 5 7)",p=0.5,lpf="100+ 500*(lsin 8)", res=0.2, shape=0.5)
...
Pa * zd("arp:[0:5]", "^ ^ t (7 5 3)+<0 7 5>",
        ...
        lpf="1500*(ulsin 2)",res=0.4,
        gain=1, pan="0.5 0.75 0.25 0.15 0.5 075 0 1",
        )
...
Ph * d("(eu casio:2 13 15)", p="0.5!23 0.125!4", leg=0.1, orbit=1,
            delay="(g del)",delayfb="(g del)*0.5", delaytime=0.5,
            speed="1*(g speeder)",
        )

Ps * d("(eu lsdelectro:[1] 6 15)", shape=0.6, leg=0.25, orbit=1,
            delay="(g del)",delayfb="(g del)*0.5", delaytime=0.5,
            speed="1*(g speeder)",
        )

PS * d("(eu lsdelectro:[56] 6 15)", p=0.5, shape=0.6, 
            gain=0.8, leg=0.25, orbit=1,
            delay="(g del)",delayfb="(g del)*0.5", delaytime=0.5,
            speed="1*(g speeder)",
        )

ph * d("leHIHAT:[8]", leg=0.15, p=0.25, orbit=1, shape=0.8, 
...
PS * d("(eu lsdelectro:[56:85] 6 15)", p=0.5, shape=0.6, leg=0.25, orbit=1,
            delay="(g del)",delayfb="(g del)*0.5", delaytime=0.5,
            speed="1*(g speeder)",gain=0.9
        )

KK * d("(eu {protokick f} 3 5)", p=0.5, shape=0.5, lpf=1500,orbit="6 1",
        #speed="(1+(lsaw 4))|(1+(lsin 4))"
        )
...
ss * zd("jungbass:14"," r 5 r r 7 q r r", scale="rocritonic", speed= 1.5,
...
Pk * d("f . laSNARE:[1~18] .", p=0.5, shape=0.45, room=0.15, 
        #pan="{0 2/8 4/8 6/8}", orbit=2
        )
...
Pk * d("f (leKICK:0~8) (laSNARE:1~18)", 
...
Pk * d("{(f:0) (sid:2)} {(kick:0~8) (sid:2)} laSNARE:[1~18] sid:2", 
...
Pk * d("(eu protokick [2~5] [6~9])", gain=0.93,
        shape=0.9,lpf="2500*(lsaw 4)",res="(lsin 1)*0.5",p="0.25!4 0.5",
        #pan="{0 2/8 4/8 6/8}"
        )
...
def lerythme(p=0.5,i=0):
    ...
    D('. . lsdelectro:[1:10] .', room=0.8, size=0.5, dry='0.3 0.5 0.1',
...
Pd * d('february:[0:10]', amp=0.4, p=.5, leg=.05, pan='rand', 
       speed='(if (beat 0 2) 1 0.5)*2', hpf='2000+(ulsin 4)', orbit=5)
...
@swim 
def lerythme(p=0.5,i=0):
    D("lsdelectro:1 . kick:5 .. protokick:10", triode=0.3, 
            euclid=(3,3,1), leg=.4,
            shape=0.65, div=2, i=i, hpf='40~50') # régler
...
pJ >> None
def intro():
    Pi >> zd('leCASIOvib:2', vengaboys, gain=0.9, leg=0.5, triode=.3)
    #Pj >> zd('synthi:63',vengaboys1, dur=0.1, leg=1, orbit=2, room=0.5, size=0.7, dry=0.5)
    Pj >> zd('braids', vengaboys2, model=2, dur=0.8, orbit=2, amp=0.455, leg=1, room=0.5, size=0.7, dry=0.5)
    pJ * zn(vengaboys2, channel=1, dur=0.8)
intro()


dd * d('. lsdelectro:4 . lsdelectro:4',p=.25, amp='0.2~0.5', leg=0.15)
de * d('protokick . snare:10 .', shape=.5, triode=.3)

Pg * d("clic:[0~152]",
        shape=0.5,pan="[[[0:8]!!2!!4]/8]|[[[8:0]!!2!!4]/8]", 
        lpf="1000*(lsaw 12)",res="(lsin 1)*0.5",p=0.25,
        )
...
pJ * None
def refrain():
    Pi >> zd('{synthi:65 braids}', vengaboys4, model=2, dur=0.8, orbit=2, 
            amp=0.55, leg=1, room=0.5, size=0.7, dry=0.5,
            accelerate = "{-0.5*rand 0.5*rand}"
            )
    Pj >> zd('leCASIOvib:2', vengaboys, dur=0.1,orbit=2, amp=0.25, 
...
PS * d("(eu lsdelectro:[56] 6 15)", p=0.5, shape=0.6, leg=0.25, orbit=1,
            delay="(g del)",delayfb="(g del)*0.5", delaytime=0.5,
            speed="1*(g speeder)",
        )
...
KK * d("(eu {protokick f} 3 5)", p=0.5, shape=0.9, lpf=1500,orbit="6 1")
...
ss * zd("jungbass:14"," r 5 r 7 q r r", scale="rocritonic", speed= 1.5,
        octersub=3, orbit = 4, triode = 0.9, gain=1)
